...
public class StashedHandleViewController implements TaskbarControllers.LoggableTaskbarController,
    ...
    @Nullable
    private SafeCloseable mNavHandleSettingListener;
    ...
    public StashedHandleViewController(TaskbarActivityContext activity,
        ...
        setNavHandleHidden(Settings.Secure.getInt(activity.getContentResolver(),
    ...
    public void init(TaskbarControllers controllers) {
        ...
        mNavHandleSettingListener = SettingsCache.INSTANCE.get(activity)
                .getListenableRef(NAVIGATION_HANDLE_HIDDEN_URI)
                .forEach(Executors.MAIN_EXECUTOR, (isEnabled) -> {
                    setNavHandleHidden(isEnabled);
                    return null;
                });
    ...
    public void onDestroy() {
        ...
        if (mNavHandleSettingListener != null) {
            mNavHandleSettingListener.close();
            mNavHandleSettingListener = null;
        }
        stopBurnInTimer();
    }
    ...
    private void setNavHandleHidden(boolean hidden) {
        mIsNavHandleHiddenBySetting = hidden;
        mTaskbarStashedHandleAlpha.get(ALPHA_INDEX_NAV_HANDLE_HIDDEN).setValue(hidden ? 0 : 1);
    }
}
