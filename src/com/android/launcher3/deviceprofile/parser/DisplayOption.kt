...
private constructor(@JvmField val grid: GridOption, context: Context, ta: TypedArray) {
    ...
    private val iconSizeModifier: Float =
        LauncherPrefs.getPrefs(context).getInt(InvariantDeviceProfile.KEY_ICON_SIZE, 100) / 100f
    private val fontSizeModifier: Float =
        LauncherPrefs.getPrefs(context).getInt(InvariantDeviceProfile.KEY_FONT_SIZE, 100) / 100f
